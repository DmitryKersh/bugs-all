...
import static com.github.dmitrykersh.bugs.api.board.tile.TileState.QUEEN;
...
public abstract class AbstractBoard {
    ...
    public void addPlayer(int number, PlayerSettings settings) {
        players.set(number, new HumanPlayer(this,
